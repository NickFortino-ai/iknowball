                          ...
                          return (
                            ...
                            >
                              <div className="flex items-start gap-2">
                                <span className="flex-shrink-0">{n.type === 'reaction' ? '\uD83D\uDD25' : n.type === 'comment' ? '\uD83D\uDCAC' : n.type === 'survivor_win' ? '\uD83D\uDC51' : n.type === 'league_win' && n.metadata?.isWinner === false ? (n.metadata?.points < 0 ? '\uD83D\uDCC9' : '\uD83D\uDCCA') : n.message?.includes('lost') ? '\u274C' : '\uD83C\uDFC6'}</span>
