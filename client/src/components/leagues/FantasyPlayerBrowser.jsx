    ...
    <div className="rounded-xl border border-text-primary/20 overflow-hidden bg-bg-primary">
            ...
            return (
              <div key={player.id} className="flex border-b border-border last:border-0">
                <div className="sticky left-0 z-10 bg-bg-primary flex items-center shrink-0">
                  ...
                  <div className="w-[135px] lg:w-[200px] flex items-center gap-2 px-1 py-2.5">
                ...
                <div className="flex gap-0.5 items-center">
                  {statColumns.map((col) => {
                    ...
                    return (
                      <div
                        key={col.key}
                        className={`w-11 shrink-0 text-center text-xs tabular-nums py-1 ${
                          sortKey === col.key ? 'text-text-primary font-bold' : 'text-text-secondary'
                        }`}
                      >
                        {value}
                      </div>
      ...
      {addingPlayer && (
        <div className="fixed inset-0 z-50 bg-black/60 flex items-end md:items-center justify-center" onClick={() => { setAddingPlayer(null); setBidAmount(0) }}>
          <div className="bg-bg-secondary w-full md:max-w-md rounded-2xl mx-3 mb-[calc(5.5rem+env(safe-area-inset-bottom))] md:mb-0 md:mx-0 p-5 max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
