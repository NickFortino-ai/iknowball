      ...
      <div className="order-1 lg:col-start-1 lg:row-start-1">
        ...
        <div className="rounded-xl border border-text-primary/15 bg-bg-primary/10 backdrop-blur-sm p-4 mb-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-text-primary">This Week's INT Picks</h3>
        ...
        {hasSavedPicks && !editing && (() => {
          ...
          return (
            <div className="flex items-center justify-end gap-4 px-1 mb-2 -mt-1">
              ...
              <span className={`font-display text-sm ${weekInts > 0 ? 'text-correct' : 'text-text-muted'}`}>{weekInts} INT{weekInts === 1 ? '' : 's'}</span>
            </div>
          )
        })()}
