...
const FORMAT_DESCRIPTIONS = {
  ...
  wnba_dfs: 'Build a fresh roster every WNBA game day under a salary cap. No long-term commitment — just nightly rosters.',
...
export default function LeagueInfoModal({ league, onClose, onJoin, joining }) {
  useEffect(() => {
    if (!league) return
    lockScroll()
    return () => unlockScroll()
