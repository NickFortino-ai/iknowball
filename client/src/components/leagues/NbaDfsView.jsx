                      ...
                      {hidden ? (
                        ...
                        <>
                          ...
                          <div className="flex-1 min-w-0 lg:flex lg:items-center lg:gap-6">
                            ...
                            {!slot.away_team && slot.team && slot.opponent && (
                              <span className="text-[11px] text-text-muted block mt-0.5 lg:mt-0 lg:text-xs lg:w-44 lg:shrink-0 lg:text-right">
...
export default function NbaDfsView({ league, tab = 'roster' }) {
  ...
  // Pickable dates: today/tomorrow inside [leagueStart, leagueEnd]. Without
  // the end gate, the roster builder stayed open after the league closed.
  ...
  // Pre-start → first day; post-end → last day. Previously always fell
  // back to leagueEnd, opening not-yet-started leagues on their final date.
