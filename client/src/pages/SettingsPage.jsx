  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <Section label="Profile Backdrop" defaultOpen={true}>
        ...
        <div className="flex gap-1.5 flex-wrap mb-3">
          {[
            ...
            { key: 'three_point_contest', label: 'NBA 3PT Shooters' },
            { key: 'wnba_three_point_contest', label: 'WNBA 3PT Shooters' },
      ...
      <button
        ...
        className={`w-full font-semibold py-3 rounded-xl transition-colors my-2 ${saving || !hasChanges ? 'bg-text-muted/30 text-text-muted cursor-not-allowed' : 'bg-accent hover:bg-accent-hover text-white'}`}
      >
