...
export default function LeagueDetailPage() {
  ...
  return (
    <div className="relative">
      ...
      {!(league.format === 'bracket' && isBracketLocked) && (
      <div className="relative z-10 mb-6 flex gap-2 overflow-x-auto no-scrollbar scroll-smooth px-2 md:px-0 justify-center md:flex-wrap" style={{ WebkitOverflowScrolling: 'touch' }}>
        {tabs.map((tab, i) => {
