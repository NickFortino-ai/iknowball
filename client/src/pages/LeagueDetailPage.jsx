  ...
  function buildNarrative() {
    ...
    if (league.format === 'hr_derby') {
      return [
        ...
        'The winner earns a bonus that scales with league size: ≤5 members +10, 6–10 +20, 11–15 +30, 16–30 +50, 31–40 +75, 41+ +100.',
      ]
    }
  ...
  return (
    <div className="relative">
      ...
      <div className="mb-6 relative z-10">
        ...
        <div className={['bracket', 'fantasy', 'nba_dfs', 'mlb_dfs', 'hr_derby', 'survivor', 'pickem', 'squares', 'td_pass'].includes(league.format) ? 'text-center' : ''}>
        <div className={`flex items-center gap-2 mt-2 ${['bracket', 'fantasy', 'nba_dfs', 'mlb_dfs', 'hr_derby', 'survivor', 'pickem', 'squares', 'td_pass'].includes(league.format) ? 'justify-center' : ''}`}>
