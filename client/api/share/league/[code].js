...
export default async function handler(req, res) {
  ...
  // Use our own custom-rendered OG card (generated by /api/og/league/[code])
  // — backdrop as background, league name overlay, format badge, JOIN NOW
  // CTA. Falls back to the static og-image only if we couldn't even resolve
  // the league.
  const ogImageUrl = league
    ? `https://${host}/api/og/league/${encodeURIComponent(code)}`
