...
export const PROP_MARKETS = {
  // NBA
  player_points: { label: 'Points', sports: ['basketball_nba', 'basketball_ncaab'] },
  player_rebounds: { label: 'Rebounds', sports: ['basketball_nba', 'basketball_ncaab'] },
  player_assists: { label: 'Assists', sports: ['basketball_nba', 'basketball_ncaab'] },
  player_threes: { label: '3-Pointers Made', sports: ['basketball_nba', 'basketball_ncaab'] },
  player_blocks: { label: 'Blocks', sports: ['basketball_nba', 'basketball_ncaab'] },
  player_steals: { label: 'Steals', sports: ['basketball_nba', 'basketball_ncaab'] },
  player_points_rebounds_assists: { label: 'Pts + Reb + Ast', sports: ['basketball_nba', 'basketball_ncaab'] },
  player_points_rebounds: { label: 'Pts + Reb', sports: ['basketball_nba', 'basketball_ncaab'] },
  player_points_assists: { label: 'Pts + Ast', sports: ['basketball_nba', 'basketball_ncaab'] },
  player_rebounds_assists: { label: 'Reb + Ast', sports: ['basketball_nba', 'basketball_ncaab'] },
