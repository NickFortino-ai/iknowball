  ...
  try {
    ...
    if (playerIds.length) {
      const { data: stats } = await supabase
        .from('nfl_player_stats')
        .select('player_id, pass_att, pass_cmp, pass_yd, pass_td, pass_int, rush_att, rush_yd, rush_td, rec, rec_yd, rec_td, rec_tgt, fum_lost, two_pt, fgm_0_39, fgm_40_49, fgm_50_plus, fgmiss_0_39, fgmiss_40_49, fgmiss_50_plus, xpm, def_sack, def_int, def_fum_rec, def_td, def_safety, def_pts_allowed, idp_tkl_solo, idp_tkl_ast, idp_tkl_loss, idp_sack, idp_int, idp_pass_def, idp_qb_hit, idp_ff, idp_fum_rec')
        .eq('week', week)
        .eq('season', season)
...
export async function getPlayerDetail(leagueId, playerId) {
  ...
  const { data: weeks } = await supabase
    .from('nfl_player_stats')
    .select('week, season, pass_att, pass_cmp, pass_yd, pass_td, pass_int, rush_att, rush_yd, rush_td, rec_tgt, rec, rec_yd, rec_td, fum_lost, two_pt, fgm_0_39, fgm_40_49, fgm_50_plus, fgmiss_0_39, fgmiss_40_49, fgmiss_50_plus, xpm, def_sack, def_int, def_fum_rec, def_td, def_safety, def_pts_allowed, idp_tkl_solo, idp_tkl_ast, idp_tkl_loss, idp_sack, idp_int, idp_pass_def, idp_qb_hit, idp_ff, idp_fum_rec')
    .eq('player_id', playerId)
    .eq('season', season)
    .order('week', { ascending: true })
    ...
    try {
      ...
      if (posPlayerIds.length) {
        const { data: posStats } = await supabase
          .from('nfl_player_stats')
          .select('player_id, pass_yd, pass_td, pass_int, rush_yd, rush_td, rec, rec_yd, rec_td, fum_lost, two_pt, fgm_0_39, fgm_40_49, fgm_50_plus, fgmiss_0_39, fgmiss_40_49, fgmiss_50_plus, xpm, def_sack, def_int, def_fum_rec, def_td, def_safety, def_pts_allowed, idp_tkl_solo, idp_tkl_ast, idp_tkl_loss, idp_sack, idp_int, idp_pass_def, idp_qb_hit, idp_ff, idp_fum_rec')
          .eq('season', season)
...
export async function scoreFantasyMatchupsWeek(week, season) {
  ...
  if (allPlayerIds.length) {
    const { data: stats } = await supabase
      .from('nfl_player_stats')
      .select('player_id, pass_yd, pass_td, pass_int, rush_yd, rush_td, rec, rec_yd, rec_td, fum_lost, two_pt, fgm_0_39, fgm_40_49, fgm_50_plus, xpm, def_sack, def_int, def_fum_rec, def_td, def_safety, def_pts_allowed, idp_tkl_solo, idp_tkl_ast, idp_tkl_loss, idp_sack, idp_int, idp_pass_def, idp_qb_hit, idp_ff, idp_fum_rec')
      .eq('week', week)
      .eq('season', season)
      .in('player_id', allPlayerIds)
