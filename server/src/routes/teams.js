...
export const FALLBACK_TEAMS = {
  ...
  americanfootball_ncaaf: [
    // Full FBS list, alphabetical. Names match ESPN's canonical format
    // so games-sync team strings line up cleanly with the autocomplete.
    ...
    'Colorado State Rams', 'Connecticut Huskies', 'Delaware Blue Hens', 'Duke Blue Devils',
    'East Carolina Pirates', 'Eastern Michigan Eagles', 'FIU Panthers', 'Florida Atlantic Owls',
    'Florida Gators', 'Florida State Seminoles', 'Fresno State Bulldogs', 'Georgia Bulldogs',
    'Georgia Southern Eagles', 'Georgia State Panthers', 'Georgia Tech Yellow Jackets',
    "Hawai'i Rainbow Warriors", 'Houston Cougars', 'Illinois Fighting Illini', 'Indiana Hoosiers',
    'Iowa Hawkeyes', 'Iowa State Cyclones', 'Jacksonville State Gamecocks', 'James Madison Dukes',
    'Kansas Jayhawks', 'Kansas State Wildcats', 'Kennesaw State Owls', 'Kent State Golden Flashes',
    'Kentucky Wildcats', 'Liberty Flames', 'Louisiana Ragin\' Cajuns', 'Louisiana Tech Bulldogs',
    'Louisiana-Monroe Warhawks', 'Louisville Cardinals', 'LSU Tigers', 'Marshall Thundering Herd',
    'Maryland Terrapins', 'Massachusetts Minutemen', 'Memphis Tigers', 'Miami (OH) RedHawks',
    'Miami Hurricanes', 'Michigan State Spartans', 'Michigan Wolverines', 'Middle Tennessee Blue Raiders',
    'Minnesota Golden Gophers', 'Mississippi State Bulldogs', 'Missouri State Bears',
    ...
    'South Florida Bulls', 'Southern Miss Golden Eagles', 'Stanford Cardinal',
    'Syracuse Orange', 'TCU Horned Frogs', 'Temple Owls', 'Tennessee Volunteers',
    'Texas A&M Aggies', 'Texas Longhorns', 'Texas State Bobcats', 'Texas Tech Red Raiders',
    ...
    'Utah State Aggies', 'Utah Utes', 'UTEP Miners', 'UTSA Roadrunners',
