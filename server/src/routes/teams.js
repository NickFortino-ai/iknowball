...
export const FALLBACK_TEAMS = {
  ...
  basketball_wncaab: [
    'Baylor Bears', 'Connecticut Huskies', 'Duke Blue Devils', 'Iowa Hawkeyes',
    'Iowa State Cyclones', 'JMU Dukes', 'Kansas State Wildcats', 'Louisville Cardinals',
    'LSU Tigers', 'Maryland Terrapins', 'NC State Wolfpack', 'Notre Dame Fighting Irish',
    'Ohio State Buckeyes', 'Oklahoma Sooners', 'Oregon Ducks', 'South Carolina Gamecocks',
    'Stanford Cardinal', 'TCU Horned Frogs', 'Tennessee Lady Vols', 'Texas Longhorns',
    'Texas A&M Aggies', 'UCLA Bruins', 'USC Trojans', 'UConn Huskies',
