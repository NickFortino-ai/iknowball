...
const createLeagueSchema = z.object({
  ...
  format: z.enum(['pickem', 'survivor', 'squares', 'bracket', 'fantasy', 'nba_dfs', 'mlb_dfs', 'hr_derby', 'three_point', 'td_pass']),
  ...
  fantasy_settings: z.object({
    format: z.enum(['traditional', 'salary_cap', 'hr_derby', 'three_point']).optional(),
    pick_reuse: z.enum(['weekly', 'unlimited']).optional(),
...
router.get('/backdrops', requireAuth, async (req, res) => {
  ...
  const exclusiveFilters = ['touchdown_survivor', 'td_pass_competition', 'three_point_contest']
