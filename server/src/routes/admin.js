...
// Player-blurb routes have moved to server/src/routes/blurbs.js so
// they can be gated by requireBlurbWriter (is_admin OR is_writer)
// instead of admin.js's mount-level requireAdmin.
