-- bracket_published — fired to every member of every league using a bracket
-- template the moment the admin sets picks_available_at to now/past
-- (the "go live" moment). Used for the 2026 World Cup R32 bracket where
-- the team field is unknown until June 27 when groups conclude.
