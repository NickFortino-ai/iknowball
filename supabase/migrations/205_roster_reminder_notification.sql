-- Add 'roster_reminder' to the notifications type CHECK. Sent ~1 hour
-- before the first game of a period when a user's roster/picks aren't
-- ready (empty slots, no picks made, or a starter is Out). Dedup is
-- done via notifications.metadata.periodKey, no separate log table.
