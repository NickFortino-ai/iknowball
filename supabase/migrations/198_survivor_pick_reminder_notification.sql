-- Add 'survivor_pick_reminder' notification type. Fires when a survivor
-- league's Day 1 period opens and a member hasn't made their pick yet.
-- One reminder per (user, league_week_id) so users aren't spammed.
...
ALTER TABLE notifications ADD CONSTRAINT notifications_type_check CHECK (type IN (
  ...
  'invite_requested', 'survivor_pick_reminder'
));
