-- Add 'invite_requested' to notifications type CHECK constraint.
-- Fires when a non-member previews an invite-only league and asks the
-- commissioner to invite them. Tapping the notification routes the
-- commissioner to the league's Invite Player modal with the requester's
-- username pre-filled.
