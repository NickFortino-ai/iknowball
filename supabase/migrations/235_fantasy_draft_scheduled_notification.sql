-- fantasy_draft_scheduled — fired to every league member when the
-- commissioner first sets the draft_date OR reschedules it. Distinct
-- from fantasy_draft_postponed (which fires from the /postpone-draft
-- route as part of the underfill-flow-reset flow).
