-- New notification type fired when an admin grants writer status
-- to a user. The recipient sees an in-app + push notification
-- letting them know they can now author player blurbs, etc.
