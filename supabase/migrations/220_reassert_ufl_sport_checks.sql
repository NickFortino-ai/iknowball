-- Re-assert UFL in the sport CHECK constraints. Migration 174 was supposed
-- to handle this but appears not to have run in prod (bracket_templates
-- still rejects 'americanfootball_ufl'). Re-running is idempotent thanks
-- to DROP CONSTRAINT IF EXISTS.
