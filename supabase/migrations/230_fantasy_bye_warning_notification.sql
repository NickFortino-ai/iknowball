-- fantasy_bye_warning — fired Thursday mornings to fantasy managers whose
-- current starting lineup contains any player on bye that week. One
-- consolidated notification per user per league per week (deduped).
